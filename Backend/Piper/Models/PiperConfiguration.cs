...
namespace PiperSharp.Models
{
    ...
    {
        public string ExecutableLocation { get; set; } = PiperDataExtractor.DefaultPiperExecutableLocation;
        public string WorkingDirectory { get; set; } = PiperDataExtractor.DefaultPiperLocation;
